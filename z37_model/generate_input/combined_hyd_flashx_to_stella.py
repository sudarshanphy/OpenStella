...
num1 = 490
fname = "../chk/failed_1dsph_ug_g37_2575_csm_wenoexp1_sphavg_remapped_hdf5_chk_%04d"%(num1)
...
preserve_ranges = [(0,96)]

outfile = "z37_2575_%04d_comb%02d.hyd"%(num1,ncombine)
